    ...
    return (
        <>
            ...
            <TextRow title={"Enkel, rätt och trygg IT."} inverted={true}>
                <p className="textrow-text fw-bold">Olika företag har olika utmaningar när det<br/> kommer till IT. Vårt
                    jobb är
                    att
                    hitta den bästa
            ...
            <TextRow title={"En kundnära IT"}>
                <p className="textrow-text">Vi värnar om våra kunder och sätter stort fokus på varje företags
                    unika <br/>förutsättningar.
                </p>
                <p className="textrow-text">Genom att erbjuda en komplett IT eller bara förstärka upp ert team med
                    erfarna<br/> konsulter kan vi
